...
def output_lc_info(output_media=None, lc=None):
    ...
    if output_media == 'console':
        ...
        td.append(['ebs optimised', dash_if_none(lc.get('EbsOptimized'))])
        td.append(['instance monitoring', dash_if_none(lc.get('InstanceMonitoring'))])
        ...
        td.append(['security groups', dash_if_none(lc.get('SecurityGroups'))])
